...
static const yytype_uint16 yyrline[] =
{
     ...
     349,   349,   357,   358,   359,   362,   362,   390,   390,   393,
     394,   396,   396,   396,   396,   396,   399,   400,   401,   402
};
#endif
...
#line 377 "parser.y"
    { if(strcmp(currfunccall,"printf")||strcmp(currfunccall,"scanf"))
							{ 
								...
								{	
									if (getSTparamscount(currfunccall)!=call_params_count && strcmp(currfunccall, "printf")!=0 && strcmp(currfunccall, "scanf")!=0)
